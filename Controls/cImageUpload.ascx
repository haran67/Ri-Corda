<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="cImageUpload.ascx.vb"
    Inherits="GisRI_Web.cImageUpload" %>
...
<div class="modal fade" id="myModalImmagini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
                            ...
                            <ContentTemplate>
                                <div class="portlet box blue" id="form_wizard_1">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-gift"></i>&nbsp;&nbsp;Wizard di caricamento immagini - <span class="step-title">
                                                Step
                                                ...
                                                <div class="form-body">
                                                    <ul class="nav nav-pills nav-justified steps">
                                                        <li id="li_tab1" runat="server">
                                                            <asp:LinkButton CssClass="step active" ID="lnk_tab1" runat="server" Enabled="false">
                                                                ...
                                                                <i class="fa fa-check"></i>&nbsp;Scelta immagini </span>
                                                            </asp:LinkButton>
                                                        </li>
                                                        <li id="li_tab2" runat="server">
                                                            <asp:LinkButton CssClass="step active" ID="lnk_tab2" runat="server" Enabled="false">
                                                                ...
                                                                class="desc"><i class="fa fa-check"></i>&nbsp;Dettagli immagini </span>
                                                            </asp:LinkButton>
                                                        </li>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane active" id="tab1" runat="server">
                                                            <h3 class="block">
                                                                Scegli le immagini da caricare</h3>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="horizontal-form">
                                                                        <telerik:RadAsyncUpload runat="server" ID="img_upload" MultipleFileSelection="Automatic" Culture="it-IT"
                                                                            DropZones="#DropZone1" AllowedFileExtensions="jpg,png,jpeg,gif" Localization-Select="Seleziona"  />
                                                                        <br />
                                                                    </div> 
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div id="DropZone1" class="note note-success" style="text-align:center; font-size:15px;">
                                                                        PUOI TRASCINARE QUI LE TUE IMMAGINI
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane active" id="tab2" runat="server">
                                                            <h3 class="block">
                                                                Inserisci titolo e descrizione delle immagini scelte</h3>
                                                            </h3>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <asp:DataList ID="dl_img_upload" runat="server" RepeatDirection="Horizontal" RepeatColumns="3" Width="100%">
                                                                        <ItemTemplate>
                                                                        <div class="form-body">
                                                                            <div class="row">
                                                                                <div class="col-md-12" style="text-align:center;">
                                                                                    <asp:Image ID="img_immagine" runat="server" style="max-height:100px;" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <asp:TextBox ID="txt_descrizione" runat="server" MaxLength="4000" CssClass="form-control" TextMode="MultiLine" Rows="2" placeholder="Inserisci qui la descrizione"></asp:TextBox>
                                                                                </div>
                                                                            </div>
                                                                        </div> 
                                                                        </ItemTemplate>
                                                        ...
                                                        <div class="tab-pane active" id="tab3" runat="server">
                                                            <h3 class="block">
                                                                Conferma le immagini che hai inserito</h3>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <asp:DataList ID="dl_img_confirm" runat="server" RepeatDirection="Horizontal" RepeatColumns="3" Width="100%">
                                                                        <ItemTemplate>
                                                                            <div class="form-body">
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
