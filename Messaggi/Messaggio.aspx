<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Messaggio.aspx.vb" Inherits="GisRI_Web.MessaggioP" %>
...
<body>
    ...
    <div>
        <section id="container">
            <cc:Messaggio ID="messaggio_p" Staccabile="false" runat="server" />
        </section>
    </div>
    </form>
    <script type="text/javascript">
        $(document).ready(function () {
            initSelect2();
            initMultipleSelect2();
            Init_bootstrapSwitch();
            $('#myModalMail').removeClass("modal fade");
